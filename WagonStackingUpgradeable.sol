...
contract WagonStackingUpgradeable is Initializable, PausableUpgradeable, ReentrancyGuardUpgradeable, AccessControlUpgradeable, UUPSUpgradeable  {
    ...
    IERC20MetadataUpgradeable wagon;
    ...
    function initialize(address _wagonAddress) initializer public {
        __Pausable_init();
        ...
        wagon = IERC20MetadataUpgradeable(_wagonAddress);
        lockDate = 25;
    }
    ...
    function emergencyMoveErc20(address _addressErc20, address _to, uint256 _amount) external onlyRole(MOVER_ROLE) nonReentrant {
        IERC20Upgradeable erc20 = IERC20Upgradeable(_addressErc20);
